...
void themeStartup(ThemePreset preset) {
    ...
    theme_t themeLight = (theme_t) {
		...
		.frontWaveColor = MakeColor(143, 170, 5, 255),
		.middleWaveColor = MakeColor(211, 201, 12, 255),
		.backWaveColor = MakeColor(70, 153, 3, 255),
		.backgroundColor = MakeColor(194, 219, 52, 255),
		.highlightColor = MakeColor(143, 170, 5, 255),
        .separatorColor = MakeColor(219, 218, 219, 255),
        .borderColor = MakeColor(43, 201, 0, 255),
    ...
    theme_t themeDark = (theme_t) {
        ...
        .attentionTextColor = MakeColor(255, 0, 0, 255),
		.frontWaveColor = MakeColor(211, 201, 12, 255),
		.middleWaveColor = MakeColor(143, 170, 5, 255),
		.backWaveColor = MakeColor(70, 153, 3, 255),
		.backgroundColor = MakeColor(11, 53, 0, 255),
		.highlightColor = MakeColor(224, 213, 15, 255),
        .separatorColor = MakeColor(219, 218, 219, 255),
        .borderColor = MakeColor(43, 201, 0, 255),
        .borderTextColor = MakeColor(64,64,64,255),
        .progressBarColor = MakeColor(0,224,0,255),
